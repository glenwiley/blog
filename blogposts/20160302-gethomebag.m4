...
<h3>Does the US GI Alice Pack Meet the Need?</h3>

<img src="alicepack.jpg" alt="US GI Alice Pack" style="float:right">
...
The Alice pack makes a great get home bag, it has very few negatives,
the most glaring issue some folks will have with it is that it fails
completely in the "grey man" approach.  I agree with the theory that
you want to blend in as much as possible and do as little as possible
to draw attention to yourself.  If you have to walk for more than a
week with only what you can carry on your back then I believe that is
impossible to be unobtrusive.  Physics will constrain how small you can
make your pack and still make the week long trek.  The Alice pack is
an attention getter - no way around that.  I would argue that in a SHTF
scenario you should be walking routes where you are less likely to be
seen, at times when you are less likely to be seen.  
